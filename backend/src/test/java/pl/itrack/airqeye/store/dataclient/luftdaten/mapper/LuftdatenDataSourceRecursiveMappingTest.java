...
class LuftdatenDataSourceRecursiveMappingTest {
    ...
    void setUpDependencyInjection() {
        ...
        InstallationMapper installationMapper = new InstallationMapperImpl(locationMapper, addressMapper, sensorMapper);
    ...
    void convertLuftdatenResponse() {
        ...
        assertThat(result.getInstallation().getAddress().getAdditionalAddressDetails()).isNull(); // not provided by Luftdaten
        assertThat(result.getInstallation().getAddress().getProvince()).isNull();  // not provided by Luftdaten
        ...
        assertThat(result.getInstallation().getSensor().getId()).isNull(); // do not override Entity's id
        assertThat(result.getInstallation().getSensor().getManufacturer()).isEqualTo(SENSOR_MANUFACTURER);
        ...
        assertThat(result.getMeasurementValues().get(0).getUnit()).isEqualTo(MeasurementUnit.MICROGRAMS_PER_CUBIC_METER);
        assertThat(result.getMeasurementValues().get(0).getMeasurement()).isEqualTo(result);
        assertThat(result.getMeasurementValues().get(0).getMeasurement().getInstallation().getSupplierInstallationId()).isEqualTo(LOCATION_ID);
        assertThat(result.getMeasurementValues().get(1).getId()).isNull(); // do not override Entity's id
        ...
        assertThat(result.getMeasurementValues().get(1).getUnit()).isEqualTo(MeasurementUnit.MICROGRAMS_PER_CUBIC_METER);
        assertThat(result.getMeasurementValues().get(1).getMeasurement()).isEqualTo(result);
        assertThat(result.getMeasurementValues().get(1).getMeasurement().getInstallation().getSupplierInstallationId()).isEqualTo(LOCATION_ID);
    }
