...
/**
 * This test class check only correctness of data filtering for measurements.
 * For full test of recursive data structure conversion please use LuftdatenDataSourceRecursiveMappingTest.
 */
...
class MeasurementMapperTest {
    ...
    @BeforeEach
    void setUp(@Mock MeasurementValueMapper measurementValueMapper, @Mock InstallationMapper installationMapper) {
    ...
    /**
     * For full recursive data conversion test without mocks please use LuftdatenDataSourceRecursiveMappingTest
     */
    @Test
    ...
    private LuftdatenMeasurement getLuftdatenDataSample(String country, String sensorType, String valueType) {
    ...
    /**
     * We ignore whole sensor location if no data reads at all is found after filtering out all unsupported value types
     * (like humidity or temperature, when here we look only for dust sensors data).
     */
    @Test
