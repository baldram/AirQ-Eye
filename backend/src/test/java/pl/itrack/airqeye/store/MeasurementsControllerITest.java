...
public class MeasurementsControllerITest {
    ...
    public void setUp() throws IOException {
        ResponseEntity<List<LuftdatenMeasurement>> responseEntity = new ResponseEntity<>(getSampleData(), HttpStatus.OK);
    ...
    public void shouldRetrieveProvideSingleInstallationData() throws Exception {
        ...
        final String apiUri = String.format(URI_SELECTED_MEASUREMENTS, Supplier.LUFTDATEN, EXISTING_INSTALLATION_ID);
    ...
    public void shouldThrowExceptionForNonExistingInstallation() throws Exception {
        // given
        createTestDataWithOneInstallation(EXISTING_INSTALLATION_ID);
        final String apiUri = String.format(URI_SELECTED_MEASUREMENTS, Supplier.LUFTDATEN, MISSING_INSTALLATION_ID);
        ...
        result.andExpect(content().contentType(MediaType.APPLICATION_JSON));
        assertThat(responseBody).isEqualTo(NOT_EXISTING_INSTALLATION_JSON_MESSAGE, MISSING_INSTALLATION_ID);
    }
}
