...
public class SupportedDataTypesHelper {
     ...
     * Supported are sensors for particles with a diameter of 10 µm and below as well as for particles less than 2.5 µm.
     */
    public static final String MEASUREMENT_TYPE_PM10 = "P1";
    public static final String MEASUREMENT_TYPE_PM2_5 = "P2";
    public static final List<String> SUPPORTED_MEASUREMENT_TYPES = asList(MEASUREMENT_TYPE_PM10, MEASUREMENT_TYPE_PM2_5);
