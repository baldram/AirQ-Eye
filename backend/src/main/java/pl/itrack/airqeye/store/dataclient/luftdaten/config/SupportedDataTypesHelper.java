...
public final class SupportedDataTypesHelper {
   ...
   */
  public static final List<String> SUPPORTED_SENSORS = List.of(
      "SDS011", "SDS021", "PMS1003", "PMS3003",
  ...
  public static final List<String> SUPPORTED_MEASUREMENT_TYPES = List.of(
      MEASUREMENT_TYPE_PM10, MEASUREMENT_TYPE_PM2_5);
